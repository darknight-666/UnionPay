...
import com.unionpay.evergarden.unionpay.com.unionpay.evergarden.socket.Field.File63;
...
public class File63Factory implements FileFactory {

    @Override
    public File getFile() {
        return new File63(UnionPay.getUnionCard().getType());
    }
}
