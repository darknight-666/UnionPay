...
import com.unionpay.evergarden.unionpay.com.unionpay.evergarden.socket.Field.File22;
...
public class File22Factory implements FileFactory {

    @Override
    public File getFile() {
        return new File22(UnionPay.getUnionCard().getType());
    }
}
